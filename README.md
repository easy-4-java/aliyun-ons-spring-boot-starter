...
| JDK | `17` |
| Coordinates | `io.github.easy4j:aliyun-ons-spring-boot-starter:1.0.6.RELEASE` |
...
| Property Binding | ✅ Stable | Binds `aliyun.ons.*` to `AliyunOnsMqProperties` |
...
| `ConsumerBean` | classpath + property | not created |
| `OrderConsumerBean` | classpath + property | not created |
